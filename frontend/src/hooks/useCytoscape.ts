...
import { cytoscapeStylesheet, cytoscapeLayoutOptions } from '../components/GraphVisualization/cytoscape-config';
...
export const useCytoscape = (
    ...
    useEffect(() => {
        ...
        try {
            ...
            const layoutOptions = layoutType === 'force-directed' ? 
    ...
    useEffect(() => {
        ...
        // Re-run layout
        const layoutOptions = cytoscapeLayoutOptions[options.layout || 'force-directed'];
